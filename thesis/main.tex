...
\begin{table}[h!]
	\begin{center}
		\begin{tabular}{|| p{0.13\linewidth} p{0.21\linewidth} p{0.15\linewidth} p{0.15\linewidth} p{0.23\linewidth} ||} 
 			...
 			\hline\hline
			MMLL 	& Energy Efficiency 	& $2.57 \pm 0.02$  	& $2.53 \pm 0.02$ 	& $ \pm $ \\ 
					& Boston Housing 	& $3.07 \pm 0.12$ 	& $2.66 \pm 0.06$ 	& $ \pm $ \\ 
					& Concrete Strength & $3.77 \pm 0.02$ 	& $ \pm $ 	& $ \pm $ \\ 
 					& Yacht Hydro. 		& $3.65 \pm 0.04$ 	& $ \pm $ 	& $ \pm $ \\
 			\hline
			RMSE 	& Energy Efficiency 	& $3.07 \pm 0.06$  	& $2.90 \pm 0.06$ 	& $ \pm $ \\ 
					& Boston Housing 	& $4.64 \pm 0.23$ 	& $3.64 \pm 0.23$ 	& $ \pm $ \\ 
					& Concrete Strength & $10.34 \pm 0.15$ 	& $ \pm $ 	& $ \pm $ \\ 
 					& Yacht Hydro. 		& $8.96 \pm 0.29$ 	& $ \pm $ 	& $ \pm $ 
					\\ [1ex] 
			\hline
		\end{tabular}
		\caption{Test results for prediction experiments with UCI regression datasets. Metrics are the mean marginal log-likelihood (MMLL) and root mean squared error (RMSE). LR and NN refer to linear regression and neural network, respectively. Average test metrics over 20 different train-test splits are given, along with standard errors.}
