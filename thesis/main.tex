...
%which are based on multi-layer artificial neural networks \cite{goodfellow2016}, 
...
%For example, a doctor is unlikely to trust a prediction related to cancer detection unless it is accompanied by an error estimate. 
...
This section presents a full derivation of the partial derivatives in Equations (\ref{eqn:derivatives_wrt_F}) and (\ref{eqn:derivatives_wrt_Psi}).
...
This section gives more details about the E-step and M-step in the batch EM algorithm and how they can be modified for an online algorithm.
