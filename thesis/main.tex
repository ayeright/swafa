...
\begin{table}[h!]
	\begin{center}
		\begin{tabular}{|| p{0.13\linewidth} p{0.21\linewidth} p{0.15\linewidth} p{0.15\linewidth} p{0.23\linewidth} ||} 
 			...
 			\hline\hline
			NLL 		& Energy Efficiency 	& $\mathbf{2.80 \pm 0.03}$  	& $2.87 \pm 0.03$ 			& $>10,000$ \\ 
