...
In general, online EM appears to better approximate the true covariance matrix, apart from when the spectrum range (and thus the conditioning number of the covariance matrix) is small. In particular, in the most difficult case - when the observation dimension is 1000 and the spectrum range is $[1, 10,000]$ - online EM achieves results very similar to batch SVD for moderate to large sample sizes.
