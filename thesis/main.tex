...
\begin{split}
	...
	& = \Psi^{-1} - \Psi^{-1}\matr{F}(\matr{I} + \matr{F}^\intercal \Psi^{-1} \matr{F})\matr{F}^\intercal \Psi^{-1} \\
	& = \Psi^{-1} - (\psi^{-1} \odot \matr{F}) \big(\matr{I} + \matr{F}^\intercal (\psi^{-1} \odot \matr{F})\big) (\psi^{-1} \odot \matr{F})^\intercal \\
	& = \Psi^{-1} - \matr{A} (\matr{I} + \matr{F}^\intercal \matr{A})\matr{A}^\intercal,
\end{split}
\end{align}
...
\begin{split}
	...
	& = -\Psi^{-1} \matr{F}  + \matr{A}  (\matr{I} + \matr{F}^\intercal \matr{A}) (\matr{A}^\intercal \matr{F}) \\
	& = -\matr{A}  + \matr{A} (\matr{I} + \matr{F}^\intercal \matr{A}) (\matr{A}^\intercal \matr{F})
\end{split}
\end{align}
and
\begin{align}
\begin{split}
	...
	& = \diag\Big(-\frac{1}{2}\Psi^{-1}  + \frac{1}{2}\matr{A}  (\matr{I} + \matr{F}^\intercal \matr{A}) \matr{A}^\intercal \Big) \\
	& = -\frac{1}{2}\psi^{-1} + \frac{1}{2} \text{sum}\Big(\big(\matr{A}  (\matr{I} + \matr{F}^\intercal \matr{A})\big) \odot \matr{A}, \text{ dim} = 1\Big).
\end{split}
\end{align}
...
\begin{equation}
	\nabla_\beta \E_{q(\theta)} [\log q(\theta)] = -\frac{1}{2} + \frac{1}{2} \text{sum}\Big(\big(\matr{A}  (\matr{I} + \matr{F}^\intercal \matr{A})\big) \odot \matr{A}, \text{ dim} = 1\Big) \odot \psi 
\end{equation}
\begin{equation}
...
\begin{algorithm}[!htbp] 
	...
	\begin{algorithmic}[1]
		...
		\For {$t=1,\dots,T$}
			...
			\State $\matr{B} \leftarrow -\matr{A}  + \matr{A} (\matr{I} + \matr{F}^\intercal \matr{A}) (\matr{A}^\intercal \matr{F})$
			\State $\matr{G}_\matr{F} \leftarrow \matr{B} + \alpha \matr{F} + \matr{g}_\theta \matr{h}^\intercal$
			\State $\matr{s} \leftarrow -\frac{1}{2} + \frac{1}{2} \text{sum}\Big(\big(\matr{A}  (\matr{I} + \matr{F}^\intercal \matr{A})\big) \odot \matr{A}, \text{ dim} = 1\Big) \odot \psi$
			\State $\matr{g}_\beta \leftarrow \matr{s} + \frac{\alpha}{2} \psi + \frac{1}{2} \matr{g}_\theta \odot \big(\psi^{1/2} \odot \matr{z}\big)$
