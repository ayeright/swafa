...
Gaussian processes (GPs) are a flexible class of non-parametric models. 

Any function $f:\R^D \mapsto \R$ 

Given a training set $\mathcal{D} = \{(\matr{x}_n, y_n)\}_{n=1}^{N}$, a function 
