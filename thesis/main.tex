...
%\begin{figure}[!htbp] 
%		\includegraphics[width=160mm]{plots/linear_model_weight_iterates__lr=0.1__lambda=0.001.png}
%	\caption{yjyjy}
%	\label{fig:yjytj}
%\end{figure}
