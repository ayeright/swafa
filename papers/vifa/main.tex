...
\begin{center}
	\begin{tabular}{cc}
		\includegraphics[width=85mm]{plots/yacht_hydrodynamics_posterior_mean.png}
		& \includegraphics[width=85mm]{plots/boston_housing_posterior_mean.png} \\
        (a) Yacht Hydrodynamics posterior mean
        & (b) Boston Housing posterior mean \\
		\includegraphics[width=85mm]{plots/yacht_hydrodynamics_posterior_variance.png} 
        & \includegraphics[width=85mm]{plots/boston_housing_posterior_variance.png} \\
