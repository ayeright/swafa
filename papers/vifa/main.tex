...
\begin{center}
	\begin{tabular}{cc}
		\includegraphics[width=83mm]{vifa/plots/energy_efficiency_posterior_mean.png}
		& \includegraphics[width=83mm]{vifa/plots/concrete_strength_posterior_mean.png} \\
        (a) Energy Efficiency posterior mean
        & (b) Concrete Compressive Strength  posterior mean \\
		\includegraphics[width=83mm]{vifa/plots/energy_efficiency_posterior_variance.png} 
        & \includegraphics[width=83mm]{vifa/plots/concrete_strength_posterior_variance.png} \\
        (c) Energy Efficiency posterior variance
        & (d) Concrete Compressive Strength posterior variance \\
        \includegraphics[width=83mm]
        {plots/energy_efficiency_posterior_covariance.png}
        & \includegraphics[width=83mm]
        {plots/concrete_strength_posterior_covariance.png} \\
...
\begin{center}
	\begin{tabular}{cc}
		\includegraphics[width=83mm]{plots/Breast_Cancer_posterior_mean.png}
		& \includegraphics[width=83mm]{plots/USPS_posterior_mean.png} \\
        (a) Breast Cancer posterior mean
        & (b) USPS posterior mean \\
		\includegraphics[width=83mm]{plots/Breast_Cancer_posterior_variance.png} 
        & \includegraphics[width=85mm]{plots/USPS_posterior_variance.png} \\
        (c) Breast Cancer posterior variance
        & (d) USPS posterior variance \\
        \includegraphics[width=83mm]
        {plots/Breast_Cancer_posterior_covariance.png}
        & \includegraphics[width=83mm]
        {plots/USPS_posterior_covariance.png} \\
