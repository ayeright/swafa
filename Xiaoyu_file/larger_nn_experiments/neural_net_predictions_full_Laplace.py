...
class Objective:
    ...
    def train_model(self, X: Tensor, y: Tensor, learning_rate: float, prior_alpha: float, noise_precision: float,
        ...
        tb_logger = pl_loggers.TensorBoardLogger(save_dir=f"/home/s2174572/BDL/Bayesian_DL/larger_NN_experiments/new_pl_log/neural_net_predictions_full_Laplace/{self.log_path}") # Check bugs
...
def main(dataset_label: str, dataset_input_path: str, results_output_dir: str):
    ...
    with open("/home/s2174572/BDL/Bayesian_DL/params_new_laplace.yaml", 'r') as fd: # new refers to larger nn; laplace means a different range for prior alpha
